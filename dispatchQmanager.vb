...
Public Class dispatchQmanager
        ...
        Else
            ...
            For i = 0 To (mySynqdQ.Count - 1)
                ...
                If thisC.decoderString IsNot "" Then
                    ...
                    Else
                        MessageBox.Show("decoderString q decoder error")
                        interruptCommandQ()
                    End If
                ...
                ElseIf (thisC.currentQcdm.ToString.IndexOf("NOT_A_COMMAND") = -1 And thisC.currentNv.ToString.IndexOf("NOT_AN_NV_ITEM") = -1) Then
                    ...
                    If superDecoderRing.decoder3(thisC) = True Then
                        ...
                        ''if it returns ok do nothing
                    Else
                        MessageBox.Show("(thisC.currentQcdm, thisC.currentNv) q decoder error")
                        interruptCommandQ()
                    End If
                ElseIf thisC.currentQcdm.ToString.IndexOf("Cmd.NOT_A_COMMAND") = -1 Then
                    ...
                    If superDecoderRing.decoder3(thisC) = True Then
                        ''if it returns ok do nothing
                    Else
                        MessageBox.Show("thisC.currentQcdm q decoder error")
                        interruptCommandQ()
                    End If
    ...
    Public Sub checkNvQForBadItems()
        ...
        Catch ex As Exception
            MessageBox.Show("nv check err: " + ex.ToString)
        End Try
    ...
    Public Sub generateRamReadReport(ByVal fileName As String)
        ...
        Try
            ...
            myFileStream.Close()
        Catch ex As Exception
            MessageBox.Show("Ram read err: " + ex.ToString)
        End Try
    ...
    Public Function generateRamScanReport() As List(Of String)
        ...
        Catch ex As Exception
            MessageBox.Show("Ram scan err: " + ex.ToString)
        End Try
    ...
    Public Sub generateNvReadReport(ByVal fileName As String)
        ...
        For Each c As Command In mySynqdQ
            ...
            '' MessageBox.Show("rxd: " + cdmaTerm.biznytesToStrizings(c.bytesRxd))
            ...
            Else
                ...
                '' MessageBox.Show("nvItemNumberS: " + nvItemNumberS + " itemString: " + itemString)
                ''MessageBox.Show("num " + nvItemNumberS + " rxd: " + nvData)
